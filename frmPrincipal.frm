...
Private Sub UserForm_Initialize()
    ...
    botoes = Array("btnDashboard", "btnTimeline", "btnCards", "btnPlanejamento", "btnSimulacao", "btnComparar", "btnCapacidade", "btnProducao", "btnEventos", "btnCadastros", "btnConfig")
    posY = 12
